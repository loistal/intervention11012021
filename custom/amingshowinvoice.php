...
require('custom/aming_style_showinvoice.php');
...
$ourlogofile = 'custom_available/' . $ds_customname . '_small.jpg';
 ?>
<div class="main">
  <table class="receipt" style="width: 300px">
      <?php if (file_exists($ourlogofile)): ?>
        <tr><td colspan=5 id=titlebold><img src="<?php echo $ourlogofile; ?>"></td></tr>     
      <?php endif; ?>  
    <tr><td colspan=5 id=titlebold>ETS AMING</td></tr>
    <tr><td colspan=5 id=title>Av. du Chef VAIRAATOA</td></tr>
    <tr><td colspan=5 id=title>Tél: 40.50.52.88 - Fax: 40.50.52.81</td></tr>
    <tr><td colspan=5 id=title>Bienvenue</td></tr>
    <tr><td colspan=5>&nbsp;</td></tr>
    <tr><td colspan=5>&nbsp;</td></tr>
    <tr><td id=main>Ticket N°</td><td id=main>:</td><td id=main><?php echo $format_invoiceid; ?></td><td id=main colspan=2>&nbsp;</td></tr> <?php //TODO 000000 . $invoiceid?>
    <tr><td id=main>Date......<td id=main>:</td></td><td id=main colspan=2><?php echo datefix2($invoicedate) . ' ' . $invoicetime; ?></td><td id=main colspan=2>&nbsp;</td></tr>
    <tr><td id=main>Caisse....<td id=main>:</td></td><td id=main><?php echo d_output($employeename); ?></td><td id=main colspan=1>&nbsp;</td></tr>
    <tr><td colspan=5>&nbsp;</td></tr>
    <tr><td colspan=5>&nbsp;</td></tr>
    <tr><td colspan=5 id=titlebold>* * * * * * * * * * * * *</td></tr>
    <tr><td colspan=5 id=titlebold>< FACTURE ></td></tr>
    <tr><td colspan=5 id=titlebold>* * * * * * * * * * * * *</td></tr>
    <tr><td colspan=5>&nbsp;</td></tr>    
