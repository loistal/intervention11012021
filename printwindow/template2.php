  ...
  <div class="company-logo">
    <?php if ($display_logo == 1): ?>
      <?php if (file_exists($ourlogofile)): ?>
        <div class="logo"><img src="<?php print $ourlogofile; ?>" style="max-height:175px;"></div>
      <?php endif; ?>
    <?php endif; ?>
  </div>
  ...
  <div class="box3">
    ...
    <div class="invoice-title">
      <?php if ($display_invoice_title == 1): ?>
        <span class="invoiceheading"><?php print mb_convert_case($typetext, MB_CASE_UPPER, "UTF-8"); ?> <?php print $format_invoiceid; ?></span>
        <br>
        <?php print datefix2($accountingdate); ?>
