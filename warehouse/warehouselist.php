...
$query_prm = array();
$query = 'select placementname,warehousename,placementrank,placementid,creationzone,pickingzone,transportzone,deletionzone';
...
<p><b><tr><td colspan="3"><td colspan="4" align="center">TYPE de ZONE
<thead><th>Entrepôts (ID)</th><th>Emplacement</th><th>Rank</th><th>Création</th><th>Picking</th><th>Transport</th><th>Destruction</th></thead>';
...
for ($i=0; $i < $num_results; $i++)
  ...
  echo '<tr><td align=left><b>TOTAL: ' .d_td_old(myfix($i),1) .'<td colspan="5">';
echo '</table>';
