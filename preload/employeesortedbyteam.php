...
if (!isset($employeesortedbyteamA))
{
  ...
  { 
	...
	for ($kladd_i=0;$kladd_i<$num_employees;$kladd_i++)
	{
		...
		$employeename = $employeesortedbyteam_lastnameA[$employeeid_temp] = $employeename_temp . $employeedisplayedA[$kladd_i]['employeename'];		
		$employeefirstname = $employeesortedbyteam_firstnameA[$employeeid_temp] = $employeedisplayedA[$kladd_i]['employeefirstname'];     
		$employeesortedbyteam_middlenameA[$employeeid_temp] = $employeedisplayedA[$kladd_i]['employeemiddlename'];   

		if (!empty($employeename)) { $employeename .= ' ';}
		if (!empty($employeefirstname)) { $employeename .= $employeefirstname;}

		if ($employeedisplayedA[$kladd_i]['deleted'] == 1) { $employeesortedbyteamA[$employeeid_temp] = d_trad ('deletedsquarebrackets',$employeename); }
		$employeesortedbyteamA[$employeeid_temp] = $employeename;	
